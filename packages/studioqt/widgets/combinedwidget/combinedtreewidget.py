#Embedded file name: C:/Users/hovel/Dropbox/packages/studiolibrary/1.23.2/build27/studiolibrary/packages/studioqt\widgets\combinedwidget\combinedtreewidget.py
import logging
...
class CombinedTreeWidget(CombinedItemViewMixin, QtWidgets.QTreeWidget):
    ...
    def copyText(self, column):
        ...
        clipBoard.setText(text, QtWidgets.QClipboard.Clipboard)
